...
public class LongestCommonSubString {
	...
	public static void main(String[] args) {
		...
		int m = s2.length();
		dp = new int[n + 1][m + 1];
		System.out.println("Longest Common SubString Using Recurssion:" + lcsRecurssion(s1, s2, n, m));
		System.out.println("Longest Common SubString Using Memoization:" + lcsMemoization(s1, s2, n, m));
		dp = new int[n + 1][m + 1];
		System.out.println("Longest Common SubString Using DP:" + lcsDP(s1, s2, n, m));
		System.out.println("Longest Common SubString Using Recurssion:" + lcsRecurssionPrint(s1, s2, n, m));
	}
